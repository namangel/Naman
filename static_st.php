    ...
    <body>
      ...
      <div class="container">
             ...
             <br>
      	      <p style="font-size:20;">
      	         Join the 500,000 founders that have used Naman. to start, grow, and fund their companies.
      	          <br>
                  <br><br>
          	 <button class="button" style="width:250px;background-color:#0A2B40;color:white;" onclick="location.href='register_st.php'">
        ...
        <font style="font-size:20px">Building a successful business requires more than just capital
          ...
          <br><br>
          <button class="button" style="width:250px;background-color:#0A2B40;color:white;" onclick="location.href='register_st.php'">APPLY NOW </button>
          <br>
          <br>
            </div>
            <div class="no5">.</div>
