...
<div class="grid-container">
  <div class="topnav">
    <div class="nop"> </div>
    <div class="top3">
       <a href="index.php"><img src="img/logo1.png" style="height:50px;width:135px; margin: 2px;"></a>
    </div>
    <div class="nop"> </div>
    <div class="nop"> </div>
    <div class="nop"> </div>
    ...
    <div class="nop"> </div>
    <div class="top2">
          <button class="button" onclick="location.href = 'sign_up.php'"><span >Sign Up</span></button>
      </div>
    <div class="top2">
       <button class="button" onclick="location.href = 'sign_in.php'"><span >Sign In</span></button>
    </div>
    <div class="nop"> </div>
  </div>
  ...
  <div class="item2">
    ...
    <!-- style="box-shadow: 2px 2px 8px 2px #9cc5e0";" -->
	   <!-- <b><font style="font-size:4vw;font-family:Courier;">NAMAN</font></b> -->
...
<div  class="item7">
      ...
      <!-- <div class="sub1">
        <br><br>
        <b>Find and apply to top accelerators</b>
        <p style="font-size:1.5vw;color:#7f8c8d;">We have hundreds of open accelerator programs. Easily apply to build your network and give your venture a boost.</p>
      </div> -->
