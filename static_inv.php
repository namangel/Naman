...
<div class="container">
  <div class="topnav">
    ...
    <div class="nop"> </div>
    <div class="top2">
          <button class="button" onclick="location.href='register_inv.php'"><span >Sign Up</span></button>
  ...
  <div class="title">
    ...
    <br><font style="font-size:35px;font-family:Arial;">READY TO VENTURE FORWARD?</font><br><br>
      <button class="button" type="submit" style="width:250px;background-color:#0A2B40;color:white;"  onclick="location.href='register_inv.php'">
